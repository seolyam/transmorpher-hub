...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-950 p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-glow-purple relative z-10 flex flex-col items-center">
        {/* Back Button */}
        <Link 
          href="/" 
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 max-w-xs mx-auto">
            Sign in with your Discord or Google account to upload and save your loadouts.
          </p>
        </div>

        {error && (
          <div className="w-full mb-6 p-3 bg-red-950/30 border border-red-900 text-red-400 rounded-md text-sm text-center">
            {error}
          </div>
        )}
        ...
        <div className="w-full flex flex-col gap-3">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-md font-medium transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white text-slate-900 hover:bg-slate-100 rounded-md font-medium transition-colors disabled:opacity-50 shadow-[0_0_15px_rgba(255,255,255,0.05)]"
          >
