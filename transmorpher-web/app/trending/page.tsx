      ...
      <section className="w-full max-w-[1440px] mx-auto px-6 py-12 flex flex-col items-center justify-center text-center gap-6 animate-in fade-in duration-500">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-4">
          <div className="flex bg-slate-900/80 p-1 rounded-full border border-slate-800 backdrop-blur-sm">
            <Link href="/" className="px-5 py-1.5 rounded-full text-sm font-medium transition-colors text-slate-400 hover:text-slate-200">
              Discover
            </Link>
            <Link href="/trending" className="px-5 py-1.5 rounded-full text-sm font-medium transition-colors bg-slate-800 text-white shadow-sm">
              Trending
            </Link>
